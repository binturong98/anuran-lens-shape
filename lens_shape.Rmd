...
specimen_means <- lens_data %>%
  ...
  group_by(specimen_id, genus_species, family, life_stage, adult_ecology, activity_period, scan_source) %>%
...
Number of specimens sampled by source `r num_specimen'`
