...
anis.plot <- shape.final %>%
  ...
  geom_hline(yintercept = specimen_means$mean_anisotropy[specimen_means$specimen_id == "Lens_replica"], linetype = "dotted") #add line for lens replica
...
spher.plot <- shape.final %>%
 ...
 ggplot(aes(y = value, x = stage)) +
  ...
  geom_hline(yintercept = specimen_means$mean_sphericity[specimen_means$specimen_id == "Lens_replica"], linetype = "dotted") #add line for lens replica
...
elong.plot <- shape.final %>%
  ...
  #add line for perfect sphere
  geom_hline(yintercept=1, linetype = "dashed") +
  geom_hline(yintercept = specimen_means$mean_elongation[specimen_means$specimen_id == "Lens_replica"], linetype = "dotted") #add line for lens replica
