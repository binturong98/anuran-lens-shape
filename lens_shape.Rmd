...
Here, we tidy up a few messy things. For activity period, cathemeral is changed to "both" to mirror the paper, empty ecological fields (or those termed "unknown") are changed to NA. Unused fields (e.g. alternate coding for adult habitat) are removed. When we publish final version, we should download and include this tidied datasheet instead of the raw one. 
...
adult_eye_activ<-filter(adult_eye, activity_period != "unknown") %>% droplevels()
