...
#print graph
pdf(file = "Figures/Fig5AB.pdf", width = 10,  height = 4, useDingbats=FALSE)
par(mfrow=c(1,2))
ecoPlot<-pca2d(eco.pca$x, group= Eco, shape = 16 , col =EcoColr, show.centroids = TRUE, radius =1.5,show.labels=F)
activPlot<-pca2d(activ.pca$x, group= activ, shape = 16 , col =activColr, show.centroids = TRUE, radius =1.5,show.labels=F)
dev.off()
...
#export figure
pdf(file = "Figures/Fig5cdef.pdf", width = 10,  height = 8)
plots
dev.off()
...
#print graph
pdf(file = "Figures/Fig6.pdf", width = 10,  height = 4)
plots
dev.off()
