...
#create dataframe for specimens with eye size data
eye_mean <- lens_data %>%
...
Here, we run a series of PGLS regressions to test for associations betweeen each 3D shape metric (anisotropy, elongation, and sphericity) and adult ecology (habitat and activity period). 
...
LensSize_activ$activity_period <- recode(LensSize_activ$activity_period, "cathemeral" = "both")
